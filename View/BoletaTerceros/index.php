<ul class="nav nav-pills float-right">
    <li class="nav-item">
        <a href="<?=$_base?>/dte/boleta_honorarios" title="Ver boletas de honorarios recibidas por cada período" class="nav-link">
            <i class="fas fa-user-tie"></i>
            Boletas de honorarios
        </a>
    </li>
    <li class="nav-item">
        <a href="<?=$_base?>/dte/boleta_terceros/emitir" title="Emitir boleta de tercero" class="nav-link">
            <i class="fas fa-file-invoice"></i>
            Emitir
        </a>
    </li>
    <li class="nav-item">
        <a href="<?=$_base?>/dte/boleta_terceros/buscar" title="Buscar boletas de terceros" class="nav-link">
            <i class="fas fa-search"></i>
            Buscar
        </a>
    </li>
    <li class="nav-item" class="dropdown">
        <a href="<?=$_base?>/dte/boleta_terceros/actualizar" title="Actualizar listado de boletas" class="nav-link" onclick="return Form.loading('Actualizando...')">
