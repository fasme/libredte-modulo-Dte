...
foreach ($dtes as &$dte) {
    ...
    $acciones .= ' <a href="dte_tmps/eliminar/'.$dte->receptor.'/'.$dte->dte.'/'.$dte->codigo.'" title="Eliminar DTE temporal" onclick="return eliminar(this, \'DteTmp\', \''.$dte->receptor.', '.$dte->dte.', '.$dte->codigo.'\')" class="btn btn-primary"><i class="fas fa-times fa-fw"></i></a>';
    $acciones .= ' <a href="documentos/generar/'.$dte->receptor.'/'.$dte->dte.'/'.$dte->codigo.'" title="Generar DTE y enviar al SII" onclick="return Form.confirm(this, \'¿Está seguro de querer generar el DTE?\')" class="btn btn-primary"><i class="far fa-paper-plane fa-fw"></i></a>';
    $documentos[] = [
