...
foreach ($periodos as &$p) {
    $acciones = '<a href="dte_compras/ver/'.$p['periodo'].'" title="Ver estado del libro del período" class="btn btn-primary"><i class="fa fa-search fa-fw"></i></a>';
    $acciones .= ' <a href="dte_compras/csv/'.$p['periodo'].'" title="Descargar CSV del libro del período" class="btn btn-primary'.(!$p['recibidos']?' disabled':'').'"><i class="far fa-file-excel fa-fw"></i></a>';
    $p[] = $acciones;
}
