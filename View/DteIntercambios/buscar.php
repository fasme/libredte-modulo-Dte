...
<div class="page-header"><h1>Búsqueda avanzada de documentos de intercambio</h1></div>
...
<div class="card mb-4">
    <div class="card-body">
        <div class="row">
            <div class="form-group col-md-6"><?=$f->input(['name'=>'emisor', 'placeholder'=>'RUT o razón social del emisor'])?></div>
            <div class="form-group col-md-3"><?=$f->input(['type'=>'select', 'name'=>'estado', 'options'=>['Pendientes y procesados', 'Sólo pendientes', 'Sólo procesados']])?></div>
