...
foreach ($resumen as &$r) {
    ...
    $r[] = $r['rsmnLink'] ? ('<a href="'.$_base.'/dte/dte_ventas/rcv_detalle/'.$periodo.'/'.$r['rsmnTipoDocInteger'].'" title="Ver detalles de los documentos" class="btn btn-primary"><i class="fa fa-search fa-fw"></i></a>') : '';
