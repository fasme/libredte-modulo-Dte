<ul class="nav nav-pills float-right">
    ...
    <li class="nav-item">
        <a href="<?=$_base?>/dte/boleta_honorarios/buscar" title="Buscar boletas de honorarios" class="nav-link">
            <i class="fas fa-search"></i>
            Buscar
        </a>
    </li>
    <li class="nav-item" class="dropdown">
        <a href="<?=$_base?>/dte/boleta_honorarios/actualizar" title="Actualizar listado de boletas" class="nav-link">
...
foreach ($periodos as &$p) {
    $acciones = '<a href="boleta_honorarios/ver/'.$p['periodo'].'" title="Ver listado de boletas recibidas" class="btn btn-primary"><i class="fa fa-search fa-fw"></i></a>';
    $acciones .= ' <a href="boleta_honorarios/csv/'.$p['periodo'].'" title="Descargar CSV de boletas del período" class="btn btn-primary"><i class="far fa-file-excel fa-fw"></i></a>';
    $p[] = $acciones;
