...
foreach ($Objs as &$obj) {
    ...
    $actions .= ' <a href="#" onclick="__.popup(\''.$_base.'/dte/sii/estado_envio/'.$obj->track_id.'\', 750, 550)" title="Ver el estado del envío en la web del SII"><span class="fa fa-search btn btn-default"></span></a>';
