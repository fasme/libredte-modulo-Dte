...
?>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <a class="btn btn-primary btn-block" href="<?=$_base?>/dte/dte_emitidos/pdf/<?=$Pago->dte?>/<?=$Pago->folio?>/<?=$Emisor->config_pdf_dte_cedible?>" role="button">
                    <span class="far fa-file-pdf"></span>
                    Ver PDF
                </a>
            </div>
            <div class="col-md-3">
                <a class="btn btn-primary btn-block" href="<?=$_base?>/dte/dte_emitidos/xml/<?=$Pago->dte?>/<?=$Pago->folio?>" role="button">
