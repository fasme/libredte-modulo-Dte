<div class="page-header"><h1>Dte &raquo; Informes &raquo; Resultado intercambio DTEs emitidos <small>recibo: <?=$recibo?>, recepción: <?=$recepcion?> y resultado: <?=$resultado?></small></h1></div>
