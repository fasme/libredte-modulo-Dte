...
echo $f->input([
    ...
    'label' => 'Receptor',
    'check' => 'rut',
    'help' => 'RUT del receptor de la guía de despacho',
]);
echo $f->input([
    'type' => 'select',
    'name' => 'usuario',
    ...
    'help' => 'Usuario que generó el DTE de la guía de despacho',
]);
echo $f->input([
    'name' => 'vendedor',
    'label' => 'Vendedor',
    'help' => 'Código del vendedor asociado a la guía de despacho',
]);
if ($google_api_key) {
    echo $f->input([
        'type' => 'select',
